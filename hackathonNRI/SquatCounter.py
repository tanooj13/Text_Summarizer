...
video_capture = cv2.VideoCapture("C:\\Users\\megal\\Downloads\\squats.mp4")  # Initialize video capture using the video file
...
while video_capture.isOpened():
    ...
    if len(landmarks_list) != 0:
        knee_angle = pose_detector.find_angle(frame, 24, 26, 28, landmarks_list)
        hip_angle = pose_detector.find_angle(frame, 12, 24, 26, landmarks_list)
